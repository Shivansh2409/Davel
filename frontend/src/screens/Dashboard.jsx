    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans w-full">
        <main className="container mx-auto px-4 pt-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-gray-800 p-6 rounded-2xl shadow-lg border border-white/10 hover:border-purple-500 transition-all duration-300 cursor-pointer">
                    <h2 className="text-2xl font-bold text-purple-400 mb-2">Project Alpha</h2>
                    <p className="text-gray-400 mb-4">Web development project for a client.</p>
                    <div className="text-sm text-gray-500">Last updated: 3 hours ago</div>
                </div>
                <div className="bg-gray-800 p-6 rounded-2xl shadow-lg border border-white/10 hover:border-pink-500 transition-all duration-300 cursor-pointer">
                    <h2 className="text-2xl font-bold text-pink-400 mb-2">Project Beta</h2>
                    <p className="text-gray-400 mb-4">Mobile app design and prototyping.</p>
                ...
                <div className="bg-gray-800 p-6 rounded-2xl shadow-lg border border-white/10 hover:border-teal-500 transition-all duration-300 cursor-pointer">
                    <h2 className="text-2xl font-bold text-teal-400 mb-2">Project Gamma</h2>
                    <p className="text-gray-400 mb-4">Internal tool for data analysis.</p>
                    <div className="text-sm text-gray-500">Last updated: 5 days ago</div>
                </div>
            </div>
        </main>
        ...
        {isModalOpen && (
            <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => setIsModalOpen(false)}>
                <div className="bg-gray-800 p-8 rounded-2xl shadow-2xl w-full max-w-md border border-white/10 transform transition-all" onClick={(e) => e.stopPropagation()}>
                    <h2 className="text-2xl font-bold text-gray-100 mb-6">Create a New Project</h2>
                    
                    {/* Project Name Input */}
                    <div>
                    <label htmlFor="projectName" className="text-sm font-medium text-gray-400 mb-2 block">Project Name</label>
                    <input
                        id="projectName"
                        type="text"
                        value={projectName}
